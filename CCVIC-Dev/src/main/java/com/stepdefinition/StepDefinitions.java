...
public class StepDefinitions extends BaseClass {
	...
	public void launch_the_url_in_chrome() throws IOException {
		...
		fileStorage = new FileStorage(driver, wait);
		//caseparty objection
	...
	@Then("Navigate to file storage")
	public void navigate_to_file_storage() {
	   fileStorage.navigateToFileStorage();
